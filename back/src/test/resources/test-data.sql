...
insert into dermatologist_appointment (dermatologist_appointment_start_time,dermatologist_appointment_end_time,id,dermatologist_for_appointment_id,patient_with_dermatologist_appointment_id,pharmacy_for_dermatologist_appointment_id) values('2021-05-29 15:00','2021-05-29 15:30',4,1,2,1);
...
insert into medicine_infos (id, form_of_medicine, manufacturer_of_medicine, medicine_code, medicine_name, notes, prescription_regime, type_of_medicine) values (2,0,'Medic Pharmacy', '211237', 'Brufen','Brapoooooooo',1,1);

insert into medicine (medicine_average_rating, id) values (0,1);
insert into medicine (medicine_average_rating, id) values (0,2);
...
insert into items(id,medicine_amount,type_of_item,medicine_item_id,version) values (nextval('my_seq_item'),1,4,2,1);
