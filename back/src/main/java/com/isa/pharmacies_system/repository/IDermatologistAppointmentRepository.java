...
public interface IDermatologistAppointmentRepository extends JpaRepository<DermatologistAppointment,Long> {
    ...
    List<DermatologistAppointment> findAllPastDermatologistAppointment(Long id);
    ...
    List<DermatologistAppointment> findAllPastDermatologistAppointmentByPharmacy(Long idDermatologist,Long idPharmacy);
    ...
    //Nemanja
    @Query("select a from DermatologistAppointment a where a.statusOfAppointment = 1 and a.dermatologistAppointmentEndTime < CURRENT_TIMESTAMP")
    List<DermatologistAppointment> findAllReservedDermatologistAppointmentInPast();
