...
const images = [
  ...
  {
    url: 'https://thumbs.dreamstime.com/b/white-medical-prescription-icon-isolated-long-shadow-rx-form-recipe-pharmacy-medicine-symbol-green-circle-button-vector-182564280.jpg',
    title: 'Appointments',
    width: '20%',
  },
];
